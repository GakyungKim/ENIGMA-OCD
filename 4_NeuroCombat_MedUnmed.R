...
# train set
write.csv(train_harmo, file="MedUnmed_train_harmo.csv", row.names = F, na = "")
write.csv(train_harmo.cov_as, file="MedUnmed_train_harmo_cov.csv", row.names = F, na = "")

# test set
write.csv(test_harmo, file="MedUnmed_test_harmo.csv", row.names = F, na = "")
write.csv(test_harmo.cov_as, file="MedUnmed_test_harmo_cov.csv", row.names = F, na = "")
