...
### 0. load data
setwd("~/Library/Mobile Documents/com~apple~CloudDocs/connectome21/2021-1/project/ENIGMA-OCD/final/Share_v.21.11.22/Data/Analysis_1_Data split_v.21.11.22")
df_train <- read.csv("T.UnmedOCDHC_Adult_S.Train_855_v.211123.csv", header = T) #855
df_test <- read.csv("T.UnmedOCDHC_Adult_S.Test_214_v.211123.csv", header = T) #214
...
# save the results
setwd("~/Library/Mobile Documents/com~apple~CloudDocs/connectome21/2021-1/project/ENIGMA-OCD/final/NeuroCombat")
# train set
write.csv(train_harmo, file="UnmedOCDHC_train_harmo.csv")
write.csv(train_harmo.cov_as, file="UnmedOCDHC_train_harmo_cov.csv")

# test set
write.csv(test_harmo, file="UnmeOCDHC_test_harmo.csv")
write.csv(test_harmo.cov_as, file="UnmedOCDHC_test_harmo_cov.csv")
