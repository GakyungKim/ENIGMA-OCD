...
# train set
write.csv(train_harmo, file="dx_train_harmo.csv", row.names = F, na = "")
write.csv(train_harmo.cov_as, file="dx_train_harmo_cov.csv", row.names = F, na = "")

# test set
write.csv(test_harmo, file="dx_test_harmo.csv", row.names = F, na = "")
write.csv(test_harmo.cov_as, file="dx_test_harmo_cov.csv", row.names = F, na = "")
